  ...
  return (
    <AdminDashboard>
      <div className="bg-c3 pb-5">
        <div className="z-150 ml-5 mb-5 mr-5 bg-c3 pt-10 2xl:h-[1200px] rounded-2xl text-c3 hover:text-c1">
          <Card
            className="flex flex-col mb-6 pb-5 justify-items-center h-[860px] 2xl:h-[1200px] sm:w-auto bg-c2 rounded-2xl z-80"
            shadow={false}
          >
