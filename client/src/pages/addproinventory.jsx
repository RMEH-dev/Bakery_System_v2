  ...
  return (
    <AdminDashboard>
      <div className="bg-c1 pt-10 pb-10">
        <div className="ml-5  mb-5 mr-5  pt- pb-10 pr-10 bg-c2  h-[800px] rounded-2xl text-c3 hover:text-c1">
          <Card
          ...
          >
            <div className="mb-2 gap-5 flex flex-col">
              ...
              <Card
                className="flex flex-col mb-10 pr-5 mr-10 ml-10 h-[900px]  bg-white  rounded-2xl z-80"
                shadow={false}
              >
