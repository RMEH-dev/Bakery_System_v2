...
function ShippingAddress() {
  return (
    <CustomerProfile>
      <div className="z-100 -mt-[300px] ml-[350px] h-[550px] w-[600px] md:w-[400px] lg:w-[300px] xl:w-[650px] 2xl:w-[1150px] mb-6 rounded-2xl text-c3 hover:text-c1 flex flex-col space-y-1">
        <Card
          className="flex flex-col h-[550px] sm:w-auto bg-gradient-to-bl from-c2 to-c4 rounded-2xl z-80"
          shadow={false}
        >
